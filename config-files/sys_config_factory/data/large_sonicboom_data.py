"""
The parametre values of the SONICBOOM's large configuration
sources: 
...
LARGE_SONICBOOM_PROCESSOR_CONFIG = {
    # Initial count
    ...
    "fetchBufferSize": 64,#TODO: ¿debería ser 24 (de config-mixins.cala) * tamanho Instruccion en gem5?

    # Fetch queue size in micro-ops per-thread
    "fetchQueueSize": 32,

    # Decode width
    "decodeWidth": 3, #config-mixins.scala
    ...
    "LQEntries": 24,#config-mixins.scala

    # Number of store queue entries
    "SQEntries": 24,#config-mixins.scala
    ...
    "numPhysIntRegs": 100,#config-mixins.scala

    # Number of physical floating point registers
    "numPhysFloatRegs": 96,#config-mixins.scala
    ...
    "numROBEntries": 96,#config-mixins.scala
