"""
The parametre values of the SONICBOOM's mega configuration
sources: 
...
MEGA_SONICBOOM_PROCESSOR_CONFIG = {
    # Initial count
    ...
    "fetchBufferSize": 64,#TODO: ¿debería ser 32 (de config-mixins.cala) * tamanho Instruccion en gem5?

    # Fetch queue size in micro-ops per-thread
    "fetchQueueSize": 32,

    # Decode width
    "decodeWidth": 4, #config-mixins.scala
    ...
    "numROBEntries": 128,#config-mixins.scala
