"""
The parametre values of the SONICBOOM's small configuration
sources: 
...
SMALL_SONICBOOM_PROCESSOR_CONFIG = {
    # Initial count
    ...
    "fetchBufferSize": 64,#TODO: ¿debería ser 8 (de config-mixins.cala) * tamanho Instruccion en gem5?

    # Fetch queue size in micro-ops per-thread
    "fetchQueueSize": 32,

    # Decode width
    "decodeWidth": 1, #config-mixins.scala
    ...
    "LQEntries": 8,#config-mixins.scala

    # Number of store queue entries
    "SQEntries": 8,#config-mixins.scala
    ...
    "numPhysIntRegs": 52,#config-mixins.scala

    # Number of physical floating point registers
    "numPhysFloatRegs": 48,#config-mixins.scala
    ...
    "numROBEntries": 32,#config-mixins.scala
