...
parser.add_argument(
    ...
    type=str,
    required=False,
    default="/nfs/home/ce/felixfdec/ckpts_SPEC_intento_mio/RISCV",
...
board.set_kernel_disk_workload(
    ...
    checkpoint=Path("/nfs/shared/ce/gem5/ckpts/RISCV/SPEC-base")
)

simulator = Simulator(
    board=board,
#    readfile=args.script,
#    checkpoint_path=load_path.as_posix(), # This didn't give any problems in version 25.0.0.1, but it does with 25.1
    on_exit_event={
