...
parser.add_argument(
    ...
    type=int,
    required=True,
    help=f"First SPEC17 app identification's tag: {list(spec_choices)}"
)
parser.add_argument(
    "--spec_number2",
    choices=spec_choices,
...
# Event handlers
if (args.spec_number1 == 520 or args.spec_number1 == 531 or args.spec_number1 == 557 or
    args.spec_number2 == 520 or args.spec_number2 == 531 or args.spec_number2 == 557):
    total_works = 10
elif (args.spec_number1 == 526 or args.spec_number2 == 526):
    total_works = 240
else:
    total_works = 1
...
print(f"Starting simulation from checkpoint: {golden_path}")
