...
#SBATCH --job-name=RADIX_MediumSonicBOOM
#SBATCH --output=/nfs/home/ce/felixfdec/gem5/config-files-run-experiments/1-output-jobs/Splash-4/RADIX/slurm-%j.out

echo "============================================"
echo "Running Splash-4 - RADIX - MediumSonicBOOM"
echo "============================================"
...
if [ $exit_code -eq 0 ]; then
    echo "Successfully completed simulation for Splash-4/RADIX/MediumSonicBOOM"
else
    echo "Failed to complete simulation for Splash-4/RADIX/MediumSonicBOOM (exit code: $exit_code)"
fi
